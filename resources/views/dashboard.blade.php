        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-floating">
                    <textarea class="form-control azull" placeholder="Leave a comment here " rows="4" id="floatingTextarea"></textarea>
                  ...
                  <div class="mb-4">
                    ...
                    <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Username" rows="4"></textarea>
                  </div>
                  <div class="mb-6">
